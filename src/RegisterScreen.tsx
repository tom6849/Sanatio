...
const RegisterScreen = ({ navigation }: { navigation: any }) => {
  ...
  const handleRegister = () => {
    ...
    console.log("Taille:", heightNum);
    console.log("Poids:", weightNum);
    Alert.alert("Inscription réussie !");
  };

  const chooseAvatar = (selectedAvatar: any) => {
    setselectedAvatar(selectedAvatar); 
  };

  const avatars = [
    require('./img/avatar/avatar-1.jpg'),
    require('./img/avatar/avatar-2.jpg'),
    require('./img/avatar/avatar-3.jpg'),
    require('./img/avatar/avatar-4.jpg'),
    require('./img/avatar/avatar-5.jpg'),
    require('./img/avatar/avatar-6.jpg'),
    require('./img/avatar/avatar-7.jpg'),
    require('./img/avatar/avatar-8.jpg'),
    require('./img/avatar/avatar-9.jpg'),
  ];
            ...
            <View style={styles.containerProfil}>
              {avatars.map((avatar, index) => (
                <TouchableOpacity key={index} onPress={() => chooseAvatar(avatar)}>
                  <Animated.View 
                    style={[styles.item, selectedAvatar === avatar && styles.selectedItem, selectedAvatar === avatar && { transform: [{ scale: animatedValue }] }]}
                  >
